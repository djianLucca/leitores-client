...
import { DadosPessoaisCadastroComponent } from './core/dados-pessoais/dados-pessoais-cadastro/dados-pessoais-cadastro.component';
...
export const ROUTES: Routes = [
  ...
  {
    path: 'dados-pessoais', component: DadosPessoaisCadastroComponent, children: [
    ], canActivate: [AuthGuard]
  },
];
